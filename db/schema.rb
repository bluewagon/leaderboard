...
ActiveRecord::Schema.define(:version => 20130627231517) do
  ...
  add_index "user_rankings", ["user_id", "ranking_id"], :name => "index_user_rankings_on_user_id_and_ranking_id", :unique => true
